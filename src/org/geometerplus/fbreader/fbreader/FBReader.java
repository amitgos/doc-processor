...
public final class FBReader extends ZLApplication {
	...
	public FBReader(String[] args) {
		...
		//Added
		addAction(ActionCode.STUDY_GROUP, new AnnotateAction(this));
		addAction(ActionCode.ANNOTATE,new CropAction(this));
		addAction(ActionCode.CLEAR,new ClearAction(this));
		//ENd
...
//		addAction(ActionCode.SHOW_LIBRARY, new ShowLibraryAction(this));
		...
		addAction(ActionCode.SHOW_BOOKMARKS, new TestAction(this));
