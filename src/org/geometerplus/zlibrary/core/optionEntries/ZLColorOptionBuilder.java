...
public class ZLColorOptionBuilder {
	...
	public ZLColorOptionsData myData;
	...
	public static class ZLMultiColorOptionEntry extends ZLColorOptionEntry {
		...
		public ZLColor getColor() {
			...
			ZLColor color1 = (ZLColor) color;
			Log.i("Red value", " " + String.valueOf(color1.Red));
			Log.i("Green value", " " + String.valueOf(color1.Green));
			Log.i("Blue value", " "+String.valueOf(color1.Blue));
	...
	public static class ZLColorOptionsData {
		...
		public final HashMap/*<String,ZLColor>*/ myCurrentColors = new HashMap();
