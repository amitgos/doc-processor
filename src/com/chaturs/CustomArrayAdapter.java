...
public class CustomArrayAdapter extends ArrayAdapter{
		...
		int drawables[] = {R.drawable.bookshelf_icon,R.drawable.studygroup_icon,R.drawable.bookshop_icon,R.drawable.stutor_icon,R.drawable.mynotebook};
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Iv.setBackgroundResource(drawables[position%5]);
